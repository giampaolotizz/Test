...
namespace WebApplication1.Services
{
    public class ConsulHostedService : IHostedService
    {
        ...
        private CancellationTokenSource _cts; private readonly IConsulClient _consulClient;
        private readonly IOptions<ConsulConfig> _consulConfig; private readonly ILogger<ConsulHostedService> _logger; private readonly IServer _server;
        ...
        {
            _cts.Cancel();
            _logger.LogInformation("Deregistering from Consul"); try
            {
